...
public class ContactablesLoaderCallbacks implements LoaderManager.LoaderCallbacks<Cursor> {
        ...
        do {
            ...
            if (!lookupKey.equals(currentLookupKey)) {
               ...
               // tv.append(displayName + "\n");
                addItem(new ContactItem(position.toString(),displayName));
    ...
    public static List<ContactItem> CONTACT_ITEMS = new ArrayList<ContactItem>();
     ...
     */
    public static Map<String, ContactItem> CONTACT_ITEMS_MAP = new HashMap<String, ContactItem>();

    /*static {
        // Add 3 sample items.
        addItem(new ContactItem("1", "Sandra"));
        addItem(new ContactItem("2", "Gaby"));
        addItem(new ContactItem("3", "Layla"));
    }*/

    private static void addItem(ContactItem item) {
        CONTACT_ITEMS.add(item);
        CONTACT_ITEMS_MAP.put(item.id, item);
    }
